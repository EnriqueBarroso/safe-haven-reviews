      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <p className="text-muted-foreground leading-relaxed">
            ¿Tienes alguna sugerencia, has encontrado un error o necesitas ayuda con tu cuenta? Utilizamos canales cifrados para garantizar que tu comunicación sea privada.
          </p>
        ...
        <Card className="border-primary/20">
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-secondary/50 rounded-lg border border-dashed text-center">
              ...
              <a 
                href="mailto:soporte@yafui.com" 
                className="text-lg font-bold text-primary hover:underline"
              >
                enrique.barroso84@gmail.com
              </a>
            </div>
            <p className="text-[11px] text-center text-muted-foreground">
              Por favor, incluye tu **Alias** si el problema está relacionado con tu cuenta.
            </p>
          </CardContent>
        </Card>
      </div>
